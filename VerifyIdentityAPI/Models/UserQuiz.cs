namespace VerifyIdentityAPI.Models
{
    public class UserQuiz
    {
        ...
        public string? SessionId { get; set; } // This SessionID will be store in db when user logins with username-password and must be compared with the one stored in the browser
